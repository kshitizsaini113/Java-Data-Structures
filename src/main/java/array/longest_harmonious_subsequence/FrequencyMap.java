 ...
 *
 * <p>A harmonious array is an array where the difference between its maximum value
...
public class FrequencyMap {
     ...
     *
     * <p>The first pass populates a map with the frequency of each number in the input array.
     ...
     *
     * <p><b>Time Complexity:</b> O(n), where n is the number of elements in {@code nums}.
     ...
     *
     * <p><b>Space Complexity:</b> O(k), where k is the number of unique elements in
     ...
     */
    public int findLargestHarmoniousSubsequence(int[] nums) {
