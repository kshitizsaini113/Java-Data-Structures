...
public class SlidingWindow {
     ...
     *
     * <p>This method first sorts the array, which allows for an efficient sliding
     ...
     *
     * <p><b>Time Complexity:</b> O(n log n), where n is the number of elements in {@code nums}.
     * The complexity is dominated by the initial sorting of the array. The subsequent
     * sliding window scan is O(n).
     *
     * <p><b>Space Complexity:</b> O(log n) or O(1). The space used by the sorting
